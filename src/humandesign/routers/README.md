...
- **[`general.py`](general.py)** — v1 surface, no prefix:
    - `GET /health`: Service and Swiss Ephemeris status. Unauthenticated; used by the Docker healthcheck.
...
- **[`panel.py`](panel.py)** — operator web panel, Jinja2 templates from `../templates/panel/`:
