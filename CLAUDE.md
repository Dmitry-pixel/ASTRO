...
│   │   └── team_matrix.py      # Team dynamics matrix, binomial tests, bridging (3.11.0)
│   ├── services/
...
│   │   ├── team_axes.py        # Team dynamics v1.1: four characteristics (docs/team-dynamics.md)
│   │   └── team_axes_baseline.py # GENERATED by scripts/gen_team_axes_baseline.py
│   ├── utils/
